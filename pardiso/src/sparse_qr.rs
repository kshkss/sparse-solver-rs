...
pub const sparse_sor_type_t_SPARSE_SOR_FORWARD: sparse_sor_type_t = 110;
pub const sparse_sor_type_t_SPARSE_SOR_BACKWARD: sparse_sor_type_t = 111;
pub const sparse_sor_type_t_SPARSE_SOR_SYMMETRIC: sparse_sor_type_t = 112;
pub type sparse_sor_type_t = ::std::os::raw::c_uint;
...
fn bindgen_test_layout_matrix_descr() {
    const UNINIT: ::std::mem::MaybeUninit<matrix_descr> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<matrix_descr>(),
        12usize,
        concat!("Size of: ", stringify!(matrix_descr))
    );
    assert_eq!(
        ::std::mem::align_of::<matrix_descr>(),
        4usize,
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).diag) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(matrix_descr),
...
extern "C" {
    pub fn mkl_sparse_set_sorv_hint(
        type_: sparse_sor_type_t,
        A: sparse_matrix_t,
        descr: matrix_descr,
        expectedCalls: ::std::os::raw::c_int,
    ) -> sparse_status_t;
...
pub const sparse_qr_hint_t_SPARSE_QR_WITH_PIVOTS: sparse_qr_hint_t = 0;
pub type sparse_qr_hint_t = ::std::os::raw::c_uint;
extern "C" {
    pub fn mkl_sparse_set_qr_hint(A: sparse_matrix_t, hint: sparse_qr_hint_t) -> sparse_status_t;
}
extern "C" {
    pub fn mkl_sparse_d_qr(
        operation: sparse_operation_t,
        A: sparse_matrix_t,
        descr: matrix_descr,
        layout: sparse_layout_t,
...
extern "C" {
    pub fn mkl_sparse_qr_reorder(A: sparse_matrix_t, descr: matrix_descr) -> sparse_status_t;
}
extern "C" {
    pub fn mkl_sparse_d_qr_factorize(A: sparse_matrix_t, alt_values: *mut f64) -> sparse_status_t;
}
extern "C" {
    pub fn mkl_sparse_s_qr_factorize(A: sparse_matrix_t, alt_values: *mut f32) -> sparse_status_t;
}
extern "C" {
    pub fn mkl_sparse_d_qr_solve(
        operation: sparse_operation_t,
        A: sparse_matrix_t,
        alt_values: *mut f64,
        layout: sparse_layout_t,
